...
export const AGENT_TOOL_REGISTRY = {
  ...
  [CART_HANDOFF_SEND_TOOL.name]: CART_HANDOFF_SEND_TOOL,
  [DRAFT_CART_CREATE_TOOL.name]: DRAFT_CART_CREATE_TOOL,
  ...
  [ORDER_CANCEL_PROPOSE_TOOL.name]: ORDER_CANCEL_PROPOSE_TOOL,
  [ORDER_READ_TOOL.name]: ORDER_READ_TOOL,
  [ORDER_SEARCH_TOOL.name]: ORDER_SEARCH_TOOL,
  [ORDER_UPDATE_ADDRESS_PROPOSE_TOOL.name]: ORDER_UPDATE_ADDRESS_PROPOSE_TOOL,
  [PAYMENT_READ_TOOL.name]: PAYMENT_READ_TOOL,
  [RETURN_PROPOSE_TOOL.name]: RETURN_PROPOSE_TOOL,
