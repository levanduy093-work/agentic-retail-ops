...
export const AGENT_CATALOG: AgentCatalogEntry[] = [
  ...
  ...[
    ...
    ["customer-support-agent", "Customer Support Agent", "Advise customers from live catalog data and approved store knowledge, check realtime stock, and create staff-review proposals for customer-confirmed carts, address updates, cancellations, or returns.", ["support.requested", "agent.telegram.customer-message-received", "customer.cart-draft-confirmed", "customer.return-requested", "customer.cancellation-requested", "customer.address-update-requested"], ["catalog.read", "catalog.check-realtime-stock", "order.read", "order.search", "knowledge.search", "response.draft", "cart.create-draft", "order.cancel-propose", "order.update-address-propose", "return.propose"]],
