...
const catalog: CatalogDefinition[] = [
  ...
  { name: "Áo polo Piqué", category: "Áo", basePrice: 329000, weight: 280, length: 30, width: 22, height: 5, material: "Cotton piqué co giãn", description: "Áo polo cổ bẻ chỉn chu, phù hợp đi làm và gặp gỡ cuối tuần.", image: "https://images.unsplash.com/photo-1625910513413-5fc85b5d4f31?auto=format&fit=crop&w=1200&q=85" },
  ...
  { name: "Quần culottes Ease", category: "Quần", basePrice: 439000, weight: 390, length: 35, width: 27, height: 6, material: "Rayon twill", description: "Quần culottes ống rộng, cạp cao và rủ mềm cho trang phục hằng ngày.", image: "https://images.unsplash.com/photo-1506629905607-d405b7a30dbf?auto=format&fit=crop&w=1200&q=85" },
